...
import com.xpdustry.imperium.common.lifecycle.ExitService.Code
...
fun RemoteActionMessage.Action.toExitStatus() =
    when (this) {
        RemoteActionMessage.Action.EXIT -> Code.SUCCESS
        RemoteActionMessage.Action.RESTART -> Code.RESTART
    }
