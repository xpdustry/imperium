...
typealias SerializableInetAddress =
...
typealias SerializableObjectId =
...
typealias SerializableJInstant =
...
object JavaInstantSerializer : KSerializer<Instant> {
    ...
    override fun serialize(encoder: Encoder, value: Instant) = when (encoder) {
...
typealias SerializableJDuration =
...
typealias ByteArrayAsBsonBinary =
    @Serializable(with = ByteArrayAsBsonBinarySerializer::class)
    ByteArray
object ByteArrayAsBsonBinarySerializer : KSerializer<ByteArray> {
    override val descriptor = PrimitiveSerialDescriptor("ByteArrayAsBsonBinary", PrimitiveKind.STRING)
