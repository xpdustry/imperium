...
@Inject
class KillAllCommand constructor(private val afk: AfkManager, plugin: MindustryPlugin) :
    AbstractVoteCommand<Unit>(plugin, "killall", afk, 30.seconds), ImperiumApplication.Listener {
