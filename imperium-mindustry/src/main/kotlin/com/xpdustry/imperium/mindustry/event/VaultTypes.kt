...
data class Vault(val name: String, val rarity: Int, val positive: Boolean, val effects: (Int, Int) -> Unit)
...
object VaultTypes {
    val commonVault = listOf(
        ...
        Vault("test2", 1, false) { x, y ->
            LOGGER.debug("I dont want to do the rest")
        },
    )
